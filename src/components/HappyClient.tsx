...
import greg from '../assets/myclient/shegz01.png'
...
const client = [
  {img:mark, name:'Mark Gray', role:'Director & Software Engr.', review:'What truly stands out about Gregory is his incredible work ethic and relentless drive to go above and beyond to achieve project goals'},
  ...
  {img:greg, name:'Abiodun Segun', role:'Devops Engr.', review:'I would highly recommend Ootkhina Gregory for any frontend development projects, his combination of exceptional technical skills set him apart'}
]
const HappyClient = () => {
  const settings = {
    dots: true,
