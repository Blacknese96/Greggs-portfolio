    ...
    <section className='w-full h-full text-white font-poppins bg-nightBlue'>
       ...
       <Fade duration="1500" left>
        ...
        <div className='flex justify-end'>
            <div className='max-w-[926px] flex gap-5 flex-col py-5 border-y border-purple-900' key={index}>
            <div className='flex justify-between items-center'>
            <h3 className='font-semibold text-[24px] text-primary'>{item.role}</h3>
            ...
            <p className='text-base tracking-wider text-[#f4f4f4]'>{item.experience}</p>
            </div>
        ...
        <div className='max-w-[926px] w-full flex gap-5 flex-col py-5 border-y border-purple-900' key={index}>
