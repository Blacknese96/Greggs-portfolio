...
const MySkill = () => {
  ...
  return (
    <section className='w-full h-full font-poppins bg-nightBlue'  id="skills">
            <div className='flex flex-col justify-center items-center pt-20 sm:pt-24 pb-12 px-[5%] max-w-[1440px] mx-auto' >
            <Fade up duration="1500">
            <h2 className='text-lg sm:text-xl md:text-2xl text-center mb-5 text-transparent bg-clip-text bg-gradient-to-r from-[#6C4CDF] to-secondary'>Technical Abilities</h2>
